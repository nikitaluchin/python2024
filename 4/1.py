# переименуй 'a' и прочие переменные
# тест на обоих файлах
# для чего kil_num % k, когда оно не равно номеру кил?
# условие странное и случай, когда в if не зайдет (если он не может доставить во все дома?)
