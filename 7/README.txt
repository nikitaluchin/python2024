...
// сделать пустую миграцию: (затем добавил в operations hard-coded SQL script)
...
5. app folder: forms.py, views.py, urls.py; patient_form.html, patient_detail.html, person_detail.html

?. detail view либо доделать, либо убрать